...
namespace AntVault2Server.ServerWorkers
{
    class AuxiliaryServerWorker
    {
        ...
        public static Collection<string> Clients = new Collection<string>();
        ...
        internal static int GetClientID(IClientInfo client)
        {
            int ID = MainServerWorker.AntVaultServer.GetConnectedClients().First(C => C.Value.RemoteIPv4.Equals(client.RemoteIPv4)).Key;
            return ID;
        }
        ...
        {
            int ID = MainServerWorker.AntVaultServer.GetConnectedClients().First(C => C.Value.RemoteIPv4.Equals(IpPort)).Key;
            return ID;
        }
